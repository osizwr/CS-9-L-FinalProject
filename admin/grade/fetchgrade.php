...
$query = "SELECT studentID, CONCAT(lastName, ', ', firstName) AS fullName, email FROM students";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>";
            ...
            echo "<td>";
            echo "<a href='student/view-student.php?id_student=" . $row['studentID'] . "' class='btn btn-success btn-rounded'>View Grades</a>";
            echo "&nbsp;&nbsp;&nbsp;";
