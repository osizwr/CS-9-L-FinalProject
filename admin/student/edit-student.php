...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE students SET studentID = ?, firstName = ?, lastName = ?, contactNo = ?, email = ?, yearLevel = ? WHERE studentID = ?";
    $stmt = $con->prepare($sql);
    $stmt->bind_param("sssssi", $student_id, $firstname, $lastname, $phone, $email, $year_level, $student_id);
...
<html lang="en">
  <head>
    ...
    <title>SMS - Edit > <?php echo isset($row) ? htmlspecialchars($row['lastName'] . ", " . $row['firstName']) : 'N/A'; ?></title>
            ...
            <div class="page-category">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="editstudent.php" method="POST" class="user">
                        <div class="form-group row">
                            <h4>Personal Information</h4>
                            <div class="col-sm-4 mb-3">
                                Student ID: <input type="text" class="form-control form-control-user" name="studentID"
                                    value="<?php echo isset($row['studentID']) ? htmlspecialchars($row['studentID']) : 'N/A'; ?>">
                            </div>
                            <div class="col-sm-4 mb-3 mb-sm-0">
                                Last Name: <input type="text" class="form-control form-control-user" name="lastName"
                                    value="<?php echo isset($row['lastName']) ? htmlspecialchars($row['lastName']) : 'N/A'; ?>">
                            </div>
                            <div class="col-sm-4 mb-3">
                                First Name: <input type="text" class="form-control form-control-user" name="firstName"
                            ...
                            <div class="col-sm-3 mb-3 mb-sm-0">
                                Year Level: <input type="text" class="form-control form-control-user" name="yearLevel"
                            ...
                            <div class="col-sm-6 mb-3">
                                Corporate Email: <input type="text" class="form-control form-control-user" name="email"
                            ...
                            <div class="pull-left">
                                    <button type="submit" class="btn btn-success btn-rounded">Update Student</button>
                                </div>
                            </form>
                        </div>
                    </div>
